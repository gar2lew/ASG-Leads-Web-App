...
| R-018 | Staff UAT has an execution pack but no executed sign-off evidence yet. | Critical | Run `docs/UAT/`, capture tester feedback, triage issues, and obtain product owner and release manager sign-off before production approval. | Active |
